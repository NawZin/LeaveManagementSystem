...
namespace LeaveManagementSystem.Web.Controllers
{
    ...
    {       
        private readonly string MessageExistErrorMessage = "This leave type is already exist in the database";
        ...
        public async Task<IActionResult> Create(LeaveTypeCreateVM leaveTypeCreate)
        {
            ...
            {
                ModelState.AddModelError(nameof(leaveTypeCreate.Name), MessageExistErrorMessage);
            }
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeEditVM leaveTypeEdit)
        {
            ...
            {
                ModelState.AddModelError(nameof(leaveTypeEdit.Name), MessageExistErrorMessage);
            }
